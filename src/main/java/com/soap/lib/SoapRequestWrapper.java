...
public class SoapRequestWrapper {
	 private String endPoint;
	    ...
	    private String expected_Request_FilesLocation=System.getProperty("user.dir") +"/src/test/resources/";
	    ...
	    public void setRequestBody(File requestBody) {
